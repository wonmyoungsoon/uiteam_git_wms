					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">手机(mobile)验证</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">手机(mobile)验证</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">I-PIN认证</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">I-PIN认证</button>
										</div>
