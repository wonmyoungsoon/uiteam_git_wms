		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Rainbow+网络杂志</a>
							...
							<div class="webzine_banner_wrap">
								<div class="webzine_banner" id="bxslider">
									<div class="slide_wrap">
										<div class="slide">
											<img src="/app/chn/img/sub/rainbow/@img_banner.jpg" alt="">
							...
							<div class="online_write_wrap">
								...
								<ul class="webzine_list_wrap">
									<li class="webzine_list">
										<img src="/app/chn/img/sub/rainbow/@img_webzine.jpg" alt="레인보우웹진 사진">
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v6">
									...
									<a href="#" class="btn_round_border_v2">再看4个列表 (1~4/252)</a>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>多元文化家庭信息杂志“Rainbow+”每年发行四次（春、夏、秋、冬），提供13国语言版本。.</p>
							</div>
