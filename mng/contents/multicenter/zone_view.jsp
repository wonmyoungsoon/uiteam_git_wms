		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Олон соёлт гэр бүлийг дэмжих төв</a>
						...
						<div class="tab_wrap">
							<section>
								...
								<ul class="tab_support_v1">
									<li><a href="near_list.jsp">Ойр байрлах төвүүд<span>(1)</span></a></li>
									<li><a href="zone_list.jsp" class="on">Бүс нутгийн төвүүд</a></li>
								</ul>
							</section>
						</div>
						<!-- //지원센터 바로가기 -->
						...
						<div class="online_write_wrap">
							<section>
								...
								<section>
									...
									<div class="map_api">
										<img src="/app/mng/img/sub/common/@map.gif" alt="지도 정보">
									</div>
								</section>
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>Олон соёлт гэр бүлийг дэмжих төв нь олон соёлт гэр бүлийг Солонгос улсад тогтвор</p>
							</div>
