		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Тохируулга</a>
					</h1>
				</header>
				<!-- //online_header -->
						...
						<section>
							...
							<div class="setup_wrap">
								<div class="setup_list">
									Хувилбарын мэдээлэл <span class="setup_version">2.01(2)</span>
								</div>
								<div class="setup_list">
									Мэдэгдэлийг зөвшөөрөх
									<a href="#" class="btn_notice">
										<span class="btn_notice_move"></span>
									</a>
								</div>
								<div class="setup_list">
									<a href="#">Аппликэйшнийг үнэлэх</a>
								</div>
								<div class="setup_list">
									<a href="http://www.liveinkorea.kr">Олон соёлт гэр бүлийг дэмжих Данүри цахим хуудас</a>
								</div>
							</div>
						</section>
						<!-- //환경설정 상세 -->
