					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">Гар утсаар(mobile) баталгаажуулах</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">Гар утсаар(mobile) баталгаажуулах</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">Ай-пинээр(I-PIN) баталгаажуулах</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">Ай-пинээр(I-PIN) баталгаажуулах</button>
										</div>
