...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/mng/style/css/reset.css">
		<link rel="stylesheet" href="/app/mng/style/css/layouts.css">
		<link rel="stylesheet" href="/app/mng/style/css/module.css">
		<link rel="stylesheet" href="/app/mng/style/css/main.css">
		<link rel="stylesheet" href="/app/mng//style/css/common.css">
		<link rel="stylesheet" href="/app/mng/style/css/intro.css">

		<script type="text/javascript" src="/app/mng/js/jquery.js"></script>
		<script type="text/javascript" src="/app/mng/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/mng/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/mng/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/mng/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/mng/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/mng/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/mng/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/mng/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 БНСУ-д амьдрахад туслах гарын авлага</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/mng/contents/help/organization.jsp"><h3>Дэмжигч байгууллагууд</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/mng/contents/multicenter/near_list.jsp"><h3>Олон соёлт гэр бүлийг дэмжих төв</h3></a></li>
										<li><a href="/app/mng/contents/qna/callcenter.jsp"><h3>Данүри лавлах төв</h3></a></li>
										<li><a href="/app/mng/contents/qna/consulting_list.jsp"><h3>Онлайн зөвлөгөө</h3></a></li>
										<li><a href="/app/mng/contents/opinion/opinion_list.jsp"><h3>Цахим хуудасны санал гомдлын хайрцаг</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">Нийтлэг асуулт</h2>
								<ul>
								...
								<a href="/app/mng/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								<h2 class="h2_main_title">Яаралтай тусламж үзүүлэх утас</h2>
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>Данүри лавлах төв<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>Гал түймэр, түргэн тусламж, гамшгийн дуудлага болон  эмнэлгийн мэдээлэл<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>Гэмт хэргийн мэдээлэл<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
