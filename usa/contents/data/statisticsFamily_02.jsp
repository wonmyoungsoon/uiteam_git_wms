		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Multicultural Family Statistical Data</a>
				...
				<div class="online_list_wrap">
					<section>
						...
						<div class="tab_wrap">
							<section>
								...
								<ul class="tab_support_v3">
									...
									<li><a href="statisticsFamily_02.jsp" class="on">결혼이민자 자녀현황</a></li>
						...
						<!-- 다문화가족 통계 리스트 -->
						<section>
							<h2 class="blind">결혼이민자 자녀현황 상세보기</h2>

							<section>
								<!-- 서브 타이틀 -->
								<h2 class="h2_sub_title_v1">결혼이민자 및 귀화자 자녀 현황(‘15.1.1기준, 행정자치부)</h2>
								<!-- //서브 타이틀 -->

								<!-- 결혼이민자 상세 -->
								<div class="condition_list_wrap">
									<h3 class="h3_sub_title_v1">연령별 현황</h3>
								</div>

								<div class="img_graph_v2">
									<p class="blind">(단위 : 명) 만6세이하 117,877(56.8%)명 만7~12세 56,108(27%)명 만13세~15세 18,827(9%)명 만 16~18세 14,881(7.2%)명</p>
								</div>

								<div class="condition_list_wrap">
									<h3 class="h3_sub_title_v1">부모 출신국별 현황</h3>
