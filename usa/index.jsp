...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/usa/style/css/reset.css">
		<link rel="stylesheet" href="/app/usa/style/css/layouts.css">
		<link rel="stylesheet" href="/app/usa/style/css/module.css">
		<link rel="stylesheet" href="/app/usa/style/css/main.css">
		<link rel="stylesheet" href="/app/usa//style/css/common.css">
		<link rel="stylesheet" href="/app/usa/style/css/intro.css">

		<script type="text/javascript" src="/app/usa/js/jquery.js"></script>
		<script type="text/javascript" src="/app/usa/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/usa/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/usa/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/usa/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/usa/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/usa/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/usa/js/ui_common.js"></script>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/usa/contents/Life-inKorea/Life_inKorea.jsp"><h3>Life in Korea Guidebook</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/usa/contents/help/organization.jsp"><h3>Supported Organizations</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/usa/contents/multicenter/near_list.jsp"><h3>Multicultural Family Support Center</h3></a></li>
										<li><a href="/app/usa/contents/qna/callcenter.jsp"><h3>Danuri Call Center</h3></a></li>
										<li><a href="/app/usa/contents/qna/consulting_list.jsp"><h3>Online Counseling</h3></a></li>
										<li><a href="/app/usa/contents/opinion/opinion_list.jsp"><h3>Website Improvement Suggestions</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								...
								<a href="/app/usa/contents/qna/faq.jsp" class="btn_more"><span class="blind">more</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								<h2 class="h2_main_title">Emergency support</h2>
								<ul class="emergency_call_en">
									...
									<li><a href="#"><h3>Fire Rescue, First Aid, Disaster Relief,<br>Emergency Medical Service, and Hospital Information<span class="emergency_call_num">119</span></h3></a></li>
