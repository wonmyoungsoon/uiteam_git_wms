								...
								<ul class="cartoon_list_wrap">
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/jpn/img/sub/rainbow/@img_cartoon_01.jpg" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
									...
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/jpn/img/sub/common/@event_support_list2.gif" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
									...
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/jpn/img/sub/common/@event_support_list3.gif" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
									...
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/jpn/img/sub/common/img_noimg.gif" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v6">
									...
									<a href="#" class="btn_round_border_v2">リストをもっと見る(6つ） (1~6/252)</a>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
