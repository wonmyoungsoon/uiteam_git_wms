			...
			<div id="container" class="sub_container">
							...
							<div class="webzine_banner_wrap">
								<div class="webzine_banner" id="bxslider">
									<div class="slide_wrap">
										<div class="slide">
											<img src="/app/jpn/img/sub/rainbow/@img_banner.jpg" alt="">
							...
							<div class="online_write_wrap">
								...
								<ul class="webzine_list_wrap">
									<li class="webzine_list">
										<img src="/app/jpn/img/sub/rainbow/@img_webzine.jpg" alt="레인보우웹진 사진">
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v6">
									...
									<a href="#" class="btn_round_border_v2">リストをもっと見る(4つ) (1~4/252)</a>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>多文化家族情報マガジン「Rainbow+」は、年に4回（春、夏、秋、冬）13ヶ言語で刊行されています。</p>
							</div>
