					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">携帯電話（mobile）認証</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">携帯電話（mobile）認証</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">アイピン（I-PIN）認証</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">アイピン（I-PIN）認証</button>
										</div>
