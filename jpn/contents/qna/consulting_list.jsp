			...
			<div id="container" class="sub_container">
								...
								<div class="online_list_box">
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[非公開] </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">投稿者</li>
									...
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[公開] </span>무주택세대주인 다문화가족에 대한 특별공급 관련 으로 문의드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">投稿者</li>
													<li class="date_v2">김**</li>
									...
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[公開] </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">投稿者</li>
													<li class="date_v2">김**</li>
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v2">
									...
									<button id="" name="" class="btn_round_brown" onclick="location.href='consulting_write.jsp'" >問い合わせる</button>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p><span class="text_bold">1対1（マンツーマン）相談室は、多文化家族のための情報提供センター「タヌリコールセンター」が対応いたします。</span><br><br>
									言語：13ヶ国語（韓国語、ベトナム語、中国語、英語、タガログ語（フィリピン）語、モンゴル語、ロシア語、タイ語、クメール（カンボジア）語、日本語、ウズベク語、ラオス語、ネパール語）<br><br>
									時間：365日24時間/3者通話<br><br>
									電話：1577-1366
								</p>
							</div>
