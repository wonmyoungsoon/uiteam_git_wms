...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/jpn/style/css/reset.css">
		<link rel="stylesheet" href="/app/jpn/style/css/layouts.css">
		<link rel="stylesheet" href="/app/jpn/style/css/module.css">
		<link rel="stylesheet" href="/app/jpn/style/css/main.css">
		<link rel="stylesheet" href="/app/jpn//style/css/common.css">
		<link rel="stylesheet" href="/app/jpn/style/css/intro.css">

		<script type="text/javascript" src="/app/jpn/js/jquery.js"></script>
		<script type="text/javascript" src="/app/jpn/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/jpn/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/jpn/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/jpn/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/jpn/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/jpn/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/jpn/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/jpn/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 韓国生活ガイドブック</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/jpn/contents/help/organization.jsp"><h3>支援機関</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/jpn/contents/multicenter/near_list.jsp"><h3>多文化家族支援センター</h3></a></li>
										<li><a href="/app/jpn/contents/qna/callcenter.jsp"><h3>タヌリコールセンター</h3></a></li>
										<li><a href="/app/jpn/contents/qna/consulting_list.jsp"><h3>オンライン相談室</h3></a></li>
										<li><a href="/app/jpn/contents/opinion/opinion_list.jsp"><h3>ホームページ改善のためのご意見</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">よくある質問</h2>
								<ul>
								...
								<a href="/app/jpn/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								...
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>タヌリコールセンター<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>火災救助・救急・災害通報・救急医療および病院情報<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>犯罪通報<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
