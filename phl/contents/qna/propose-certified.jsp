			...
			<div id="container" class="sub_container">
					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">Pagpapatunay Gamit ang Mobile Phone</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">Pagpapatunay Gamit ang Mobile Phone</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">I-Pin authentication</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">I-Pin authentication</button>
										</div>
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>Ang one-on-one counseling room ay pinapatakbo ng  Danuri Call Center, ang information center para sa mga pamilyang multikultural.</p>
							</div>
