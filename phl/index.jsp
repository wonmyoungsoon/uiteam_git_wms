...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/phl/style/css/reset.css">
		<link rel="stylesheet" href="/app/phl/style/css/layouts.css">
		<link rel="stylesheet" href="/app/phl/style/css/module.css">
		<link rel="stylesheet" href="/app/phl/style/css/main.css">
		<link rel="stylesheet" href="/app/phl//style/css/common.css">
		<link rel="stylesheet" href="/app/phl/style/css/intro.css">

		<script type="text/javascript" src="/app/phl/js/jquery.js"></script>
		<script type="text/javascript" src="/app/phl/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/phl/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/phl/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/phl/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/phl/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/phl/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/phl/js/ui_common.js"></script>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/phl/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 Gabay na Aklat para sa Pamumuhay sa Korea</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/phl/contents/help/organization.jsp"><h3>Mga Sinusuportahang Organisasyo</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/phl/contents/multicenter/near_list.jsp"><h3>Sentrong Sumusuporta sa mga Pamilyang Multikultural </h3></a></li>
										<li><a href="/app/phl/contents/qna/callcenter.jsp"><h3>Danuri Call Center</h3></a></li>
										<li><a href="/app/phl/contents/qna/consulting_list.jsp"><h3>Pagpapayong Online</h3></a></li>
										<li><a href="/app/phl/contents/opinion/opinion_list.jsp"><h3>Mungkahi sa Pagpapabuti ng Website</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								...
								<a href="/app/phl/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								<h2 class="h2_main_title">Mga Numero ng Telepono sa Panahon ng Kagipitan</h2>
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>Danuri Call Center<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>Pagliligtas sa Panahon ng Sunog, Pangunang Lunas, Tulong sa Panahon ng Kalamidad, Impormasyon sa mga Ospital <span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>Pagsusumbong ng Krimen <span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
