		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">ການຕັ້ງຄ່າ</a>
					</h1>
				</header>
				<!-- //online_header -->
						...
						<section>
							...
							<div class="setup_wrap">
								<div class="setup_list">
									ຂໍ້​ມູນ​ສະ​ບັບ. <span class="setup_version">2.01(2)</span>
								</div>
								<div class="setup_list">
									ອະນຸຍາດການແຈ້ງເຕືອນ
								...
								<div class="setup_list">
									<a href="#">ໃຫ້ຄະແນນກັບແອັບ</a>
								</div>
								<div class="setup_list">
									<a href="http://www.liveinkorea.kr">ການສະໜັບສະໜູນຄອບຄົວຫຼາຍວັດທະນະທໍາ webportal Danuri.</a>
								</div>
							</div>
						</section>
						<!-- //환경설정 상세 -->
