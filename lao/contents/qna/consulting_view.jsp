					...
					<section>
						...
						<div class="online_write_wrap">
							...
							<div class="write_attentively">
								<section>
									<h2 class="blind">ອ່ານຂໍ້ຄວາມທີ່ຝາກໄວ້ຢູ່ຂ້າງລຸ່ມນີ້.</h2>
									<a href="#">
							...
							<section>
								...
								<div class="btn_type_v1">
									<ul>
										<li><button type="sumit" id="" name="" class="btn_round_pink" onclick="">ແກ້ໄຂ</button></li>
										<li><button type="sumit" id="" name="" class="btn_round_brown" onclick="">ລຶບ</button></li>
									</ul>
								</div>

								<div class="btn_type_v1">
									<button id="" name="" class="btn_round_brown" onclick="location.href='consulting_list.jsp'">ລາຍການ</button>
								</div>
