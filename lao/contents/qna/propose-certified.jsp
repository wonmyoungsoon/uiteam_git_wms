					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">ການ​ກວດ​ສອບ​​ທາງໂທລະສັບມືຖື</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">ການ​ກວດ​ສອບ​​ທາງໂທລະສັບມືຖື</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">ການກວດສອບໂດຍ​ການໃຊ້ I-Pin</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">ການກວດສອບໂດຍ​ການໃຊ້ I-Pin</button>
										</div>
