					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">Мобильная аутентификация</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">Мобильная аутентификация</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">Аутентификация с помощью I-Pin</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">Аутентификация с помощью I-Pin</button>
										</div>
