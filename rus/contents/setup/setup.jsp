		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Настройки</a>
					</h1>
				</header>
				<!-- //online_header -->
						...
						<section>
							...
							<div class="setup_wrap">
								<div class="setup_list">
									Информация о версии. <span class="setup_version">2.01(2)</span>
								</div>
								<div class="setup_list">
								...
								<div class="setup_list">
									<a href="#">Оценить приложение</a>
								</div>
								<div class="setup_list">
									<a href="http://www.liveinkorea.kr">Веб-портал помощи мультикультурным семьям «Данури»</a>
								</div>
							</div>
						</section>
						<!-- //환경설정 상세 -->
