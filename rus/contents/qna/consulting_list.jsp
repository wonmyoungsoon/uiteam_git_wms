						...
						<section>
							...
							<div class="online_write_wrap">
								...
								<div class="online_list_box">
									...
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[Публичная] </span>무주택세대주인 다문화가족에 대한 특별공급 관련 으로 문의드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">Автор публикации</li>
													<li class="date_v2">김**</li>
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v2">
									...
									<button id="" name="" class="btn_round_brown" onclick="location.href='consulting_write.jsp'" >Запросы</button>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
