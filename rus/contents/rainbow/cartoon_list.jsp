		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Комиксы Rainbow</a>
								...
								<ul class="cartoon_list_wrap">
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/rus/img/sub/rainbow/@img_cartoon_01.jpg" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
									...
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/rus/img/sub/common/@event_support_list2.gif" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
									...
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/rus/img/sub/common/@event_support_list3.gif" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
									...
									<li>
										<div class="cartoon_list">
											<a href="cartoon_view.jsp" class="cartoon_img"><img src="/app/rus/img/sub/common/img_noimg.gif" alt="레인보우카툰 사진"></a>
											<p class="cartoon_tit">
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v6">
									...
									<a href="#" class="btn_round_border_v2">Смотреть еще 6 (1~6/252)</a>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
				...
				<div class="help_wrap">
					<section>
						<h2 class="blind">Комиксы Rainbow 도움말</h2>
						<div class="help">
							<div class="help_text">
								<p>Комиксы из Rainbow+ можно посмотреть здесь.</p>
							</div>
