		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Центр помощи мультикультурным семьям</a>
						...
						<div class="tab_wrap">
							<section>
								...
								<ul class="tab_support_v1">
									<li><a href="near_list.jsp" class="on">Ближайшие центры помощи<span>(1)</span></a></li>
									<li><a href="zone_list.jsp">Региональные центры</a></li>
								</ul>
							</section>
						</div>
						<!-- //지원센터 바로가기 -->
							...
							<section>
								...
								<section>
									...
									<div class="detail_info">
										...
										<a href="#" class="btn_center_home" target="_blank" title="">홈페이지 바로가기</a>
									</div>
								</section>
								...
								<section>
									...
									<div class="map_api">
										<img src="/app/rus/img/sub/common/@map.gif" alt="지도 정보">
									</div>
								</section>
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>Центр помогает мультикультурным семьям обустроить свою жизнь в Корее. В Корее насчитывается 217 центров помощи, предлагающих курсы корейского языка, семейные консультации и культурные программы.</p>
							</div>
