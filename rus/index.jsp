...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/rus/style/css/reset.css">
		<link rel="stylesheet" href="/app/rus/style/css/layouts.css">
		<link rel="stylesheet" href="/app/rus/style/css/module.css">
		<link rel="stylesheet" href="/app/rus/style/css/main.css">
		<link rel="stylesheet" href="/app/rus//style/css/common.css">
		<link rel="stylesheet" href="/app/rus/style/css/intro.css">

		<script type="text/javascript" src="/app/rus/js/jquery.js"></script>
		<script type="text/javascript" src="/app/rus/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/rus/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/rus/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/rus/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/rus/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/rus/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/rus/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/rus/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 Путеводитель для проживающих в Корее</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/rus/contents/help/organization.jsp"><h3>Поддерживаемые организации</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/rus/contents/multicenter/near_list.jsp"><h3>Центр помощи мультикультурным семьям</h3></a></li>
										<li><a href="/app/rus/contents/qna/callcenter.jsp"><h3>Колл-центр Danuri</h3></a></li>
										<li><a href="/app/rus/contents/qna/consulting_list.jsp"><h3>Онлайн-консультации</h3></a></li>
										<li><a href="/app/rus/contents/opinion/opinion_list.jsp"><h3>Предложения по улучшению сайта</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">Вопросы и ответы</h2>
								<ul>
								...
								<a href="/app/rus/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								<h2 class="h2_main_title">Номера телефонов экстренных служб</h2>
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>Колл-центр Danuri<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>Информация о пожарной службе, скорой помощи и службе по чрезвычайным ситуациям, а также о больницах<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>Сообщение о преступлении<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
