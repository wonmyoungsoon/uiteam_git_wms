					...
					<section>
						...
						<div class="online_write_wrap">
								...
								<section>
									...
									<table class="table_type_v1">
										...
										<tbody>
											...
											<tr>
												<th class="bg_pink">Javob berish</th>
							...
							<section>
								...
								<div class="btn_type_v1">
									<button id="" name="" class="btn_round_brown" onclick="location.href='consulting_list.jsp'">Ro'yxat</button>
								</div>
						...
						<div class="help">
							<div class="help_text">
								<p><span class="text_bold">Baynalmilal oilalar uchun axborot markazi bo'lmish Danuri qo'ng'iroqlar markazida yuzma-yuz uchrashib maslahat berish xonasi tashkil etilgan.</span><br><br>
									Language: Korean, Vietnamese, Chinese, English, Tagalog, Mongolian, Russian, Thai, Khmer, Japanese, Uzbek, Lao, Nepalese<br><br>
									Time: Around the clock, seven days a week.<br><br>
									Phone: 1577-1366
								</p>
							</div>
