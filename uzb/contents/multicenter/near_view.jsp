		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Baynalmilal oilalarga ko‘mak berish markazi</a>
						...
						<div class="tab_wrap">
							<section>
								...
								<ul class="tab_support_v1">
									<li><a href="near_list.jsp" class="on">Yaqin atrofdagi ko'mak markazlari<span>(1)</span></a></li>
									<li><a href="zone_list.jsp">Hududiy markazlar</a></li>
								</ul>
							</section>
						</div>
						<!-- //지원센터 바로가기 -->

						<!-- Yaqin atrofdagi ko'mak markazlari 상세 안내 -->
						<div class="online_write_wrap">
							<section>
								<h2 class="blind">Yaqin atrofdagi ko'mak markazlari 상세 안내</h2>
								...
								<section>
									...
									<div class="map_api">
										<img src="/app/uzb/img/sub/common/@map.gif" alt="지도 정보">
									</div>
								</section>
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>Ko'mak markazi baynalmilal oilalarga Koreyadagi hayotga o'rnashishda yordam beradi. Koreya bo'ylab 217 ta ko'mak markazi bo'lib, ularda koreys tilini o'rgatish, oila bilan bog'liq maslahatlar berish va madaniy dasturlar tashkil etilgan.</p>
							</div>
