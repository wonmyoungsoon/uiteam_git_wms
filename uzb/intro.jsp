...
<html lang="ko">
	...
	<body>
		<div id="intro_wrap">
			<div class="intor_inside">
				<header id="intro_header">
					<h1 class="h1_intro_log">다문화가족직원포털 다누리</h1>
				</header>
				<div id="intro_contents">
					<ul class="lang_zone">
						...
						<li class="lang_zone_call">
							<a href="tel:1577-1366">
								<p class="txt">Multicultural Family Helpline</p>
								<p class="num_tell">1577-1366</p>
							</a>
						</li>
					</ul>
				</div>
				<footer id="intro_footer">
					<ul>
						<li><a href="http://www.mogef.go.kr/index.jsp" target="_blank" title="새창열림"><img src="/app/uzb/img/common/banner_logo_mogef_x3.gif" alt="여성가족부"></a></li>
						<li><a href="http://www.kihf.or.kr/" target="_blank" title="새창열림"><img src="/app/uzb/img/common/banner_logo_kihf_x3.gif" alt="한국건강가정진흥원"></a></li>
					</ul>
				</footer>
			</div>
		</div>
