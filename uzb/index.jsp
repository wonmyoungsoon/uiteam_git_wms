...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/uzb/style/css/reset.css">
		<link rel="stylesheet" href="/app/uzb/style/css/layouts.css">
		<link rel="stylesheet" href="/app/uzb/style/css/module.css">
		<link rel="stylesheet" href="/app/uzb/style/css/main.css">
		<link rel="stylesheet" href="/app/uzb//style/css/common.css">
		<link rel="stylesheet" href="/app/uzb/style/css/intro.css">

		<script type="text/javascript" src="/app/uzb/js/jquery.js"></script>
		<script type="text/javascript" src="/app/uzb/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/uzb/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/uzb/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/uzb/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/uzb/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/uzb/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/uzb/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/uzb/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 Koreyada yashash bo‘yicha qo‘llanma</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/uzb/contents/help/organization.jsp"><h3>Ko'mak tashkilotlari</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/uzb/contents/multicenter/near_list.jsp"><h3>Baynalmilal oilalarga ko‘mak berish markazi</h3></a></li>
										<li><a href="/app/uzb/contents/qna/callcenter.jsp"><h3>Danuri qo‘ng‘iroqlar markazi</h3></a></li>
										<li><a href="/app/uzb/contents/qna/consulting_list.jsp"><h3>Onlayn maslahat</h3></a></li>
										<li><a href="/app/uzb/contents/opinion/opinion_list.jsp"><h3>Veb-saytni yaxshilash bo‘yicha takliflar</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">Ko‘p so‘raladigan savollar</h2>
								<ul>
								...
								<a href="/app/uzb/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								...
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>Danuri qo‘ng‘iroqlar markazi<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>O't o'chirish xizmati, tez tibbiy yordam, tabiiy ofatlarda yordam, shifoxona haqida ma`lumot<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>Crime Report<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
