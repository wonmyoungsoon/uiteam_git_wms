			...
			<div id="container" class="sub_container">
					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">Xác thực Di động</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">Xác thực Di động</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">Xác thực I-Pin</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">Xác thực I-Pin</button>
										</div>
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>Phòng tư vấn cá nhân trực tiếp do Tổng đài Danuri điều hành, trung tâm thông tin cho gia đình đa văn hóa.</p>
							</div>
