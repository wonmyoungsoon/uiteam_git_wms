		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">Tư vấn Trực tuyến</a>
								...
								<div class="online_list_box">
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[Riêng tư] </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">Đăng bởi</li>
									...
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[Công khai] </span>무주택세대주인 다문화가족에 대한 특별공급 관련 으로 문의드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">Đăng bởi</li>
													<li class="date_v2">김**</li>
									...
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[Công khai] </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">Đăng bởi</li>
													<li class="date_v2">김**</li>
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v2">
									<h2 class="blind">Truy vấn</h2>
									<button id="" name="" class="btn_round_brown" onclick="location.href='consulting_write.jsp'" >Truy vấn</button>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p><span class="text_bold">Phòng tư vấn cá nhân trực tiếp do Tổng đài Danuri điều hành, trung tâm thông tin cho gia đình đa văn hóa.</span><br><br>
									Ngôn ngữ: Hàn Quốc, Việt Nam, Trung Quốc, Tagalog, Mông Cổ, Nga, Thái, Khmer, Nhật Bản, Uzbekistan, Lào, Nepal<br><br>
									Thời gian: 24h/ngày, 7 ngày/tuần.<br><br>
