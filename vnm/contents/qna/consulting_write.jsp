			...
			<div id="container" class="sub_container">
				...
				<div class="online_list_wrap">
					<section>
						...
						<section>
							<!-- 서브타이틀 -->
							<h2 class="h2_sub_title_v1">상담글 작성</h2>
							<!-- //서브타이틀 -->
										...
										<table class="table_type_v1">
											...
											<tbody>
												...
												<tr>
													<th>공개여부</th>
													<td>
														<input type="radio" name="set" id="open" value="Công khai"><label for="open" class="mg_r10">Công khai</label>
														<input type="radio" name="set" id="close" value="Riêng tư"><label for="close">Riêng tư</label>
													</td>
												</tr>
												<tr>
								...
								<div class="btn_type_v1">
									<section>
										...
										<ul>
											...
											<li><button type="sumit" id="" name="" class="btn_round_brown" onclick="">Hủy</button></li>
										</ul>
									</section>
								</div>
								<!-- //버튼 -->
