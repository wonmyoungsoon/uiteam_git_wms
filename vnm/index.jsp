...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/vnm/style/css/reset.css">
		<link rel="stylesheet" href="/app/vnm/style/css/layouts.css">
		<link rel="stylesheet" href="/app/vnm/style/css/module.css">
		<link rel="stylesheet" href="/app/vnm/style/css/main.css">
		<link rel="stylesheet" href="/app/vnm//style/css/common.css">
		<link rel="stylesheet" href="/app/vnm/style/css/intro.css">

		<script type="text/javascript" src="/app/vnm/js/jquery.js"></script>
		<script type="text/javascript" src="/app/vnm/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/vnm/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/vnm/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/vnm/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/vnm/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/vnm/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/vnm/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/vnm/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 Sổ tay hướng dẫn Sinh hoạt tại Hàn Quốc</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/vnm/contents/help/organization.jsp"><h3>Các Tổ chức Được hỗ trợ</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/vnm/contents/multicenter/near_list.jsp"><h3>Trung tâm Hỗ trợ Gia đình Đa văn hóa</h3></a></li>
										<li><a href="/app/vnm/contents/qna/callcenter.jsp"><h3>Tổng Đài Danuri</h3></a></li>
										<li><a href="/app/vnm/contents/qna/consulting_list.jsp"><h3>Tư vấn Trực tuyến</h3></a></li>
										<li><a href="/app/vnm/contents/opinion/opinion_list.jsp"><h3>Đề xuất Cải thiện Trang web</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">Hỏi đáp</h2>
								<ul>
								...
								<a href="/app/vnm/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								...
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>Tổng Đài Danuri<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>Thông tin về Chữa Cháy, Sơ Cứu, Cứu trợ Thiên tai, Bệnh viện<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>Báo cáo Tội phạm<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
