		...
		<div id="intro_wrap">
			<div class="intor_inside">
				...
				<footer id="intro_footer">
					<ul>
						<li><a href="http://www.mogef.go.kr/index.jsp" target="_blank" title="새창열림"><img src="/app/vnm/img/common/banner_logo_mogef_x3.gif" alt="여성가족부"></a></li>
						<li><a href="http://www.kihf.or.kr/" target="_blank" title="새창열림"><img src="/app/vnm/img/common/banner_logo_kihf_x3.gif" alt="한국건강가정진흥원"></a></li>
					</ul>
				</footer>
			</div>
		</div>
