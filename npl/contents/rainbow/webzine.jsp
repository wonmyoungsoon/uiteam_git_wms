			...
			<div id="container" class="sub_container">
							...
							<div class="webzine_banner_wrap">
								<div class="webzine_banner" id="bxslider">
									<div class="slide_wrap">
										<div class="slide">
											<img src="/app/npl/img/sub/rainbow/@img_banner.jpg" alt="">
							...
							<div class="online_write_wrap">
								...
								<ul class="webzine_list_wrap">
									<li class="webzine_list">
										<img src="/app/npl/img/sub/rainbow/@img_webzine.jpg" alt="레인보우웹진 사진">
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v6">
									...
									<a href="#" class="btn_round_border_v2">थप 4 हेर्नुहोस् (1~4/252)</a>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>बहुसांस्कृतिक परिवारका लागि प्रकाशित हुने पत्रिका Rainbow+ 13 भाषामा त्रैमासिक रूपमा प्रकाशन गरिन्छ । </p>
							</div>
