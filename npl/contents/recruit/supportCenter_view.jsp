			...
			<div id="container" class="sub_container">
				...
				<div class="online_list_wrap">
					<section>
								...
								<dl class="table_view_type_v1 mg_t3">
									...
									<dd>
										<ul class="date_wrap_v2">
											...
											<li class="date_v2">02-222-2345</li>
										</ul>
									</dd>
									<dd>
										<ul class="date_wrap_v2">
											<li class="date_tit color_black">접수기간</li>
						...
						<section>
							...
							<div class="online_write_wrap">
								<div class="btn_type_v5">
									<button id="" name="" class="btn_round_brown" onclick="location.href='supportCenter_list.jsp'">ूचि</button>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
						...
						<!-- 이전글 다음글 -->
						<section>
							<h3 class="blind">पछाडि जानुहोस् अगाडि जानुहोस् 보기</h3>
							<div class="online_write_wrap">
								<div class="paging_view">
									<dl>
										<dt>पछाडि जानुहोस्</dt>
										<dd><a href="#">[서울 성동구] 한국건강가정진흥원 직...</a></dd>
									</dl>
									<dl>
										<dt>अगाडि जानुहोस्</dt>
