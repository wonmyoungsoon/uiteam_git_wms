								...
								<div class="online_list_box">
									<a href="opinion_view.jsp">
										<dl class="online_list">
											<dt><span>निजी </span>선천적 이중국적 자녀 국적취득관련 문의</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">प्रेषित गर्ने</li>
									...
									<a href="opinion_view.jsp">
										<dl class="online_list">
											<dt><span>सार्वजनिक </span>선천적 이중국적 자녀 국적취득 관련에 대해서 관련에 대해서</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">प्रेषित गर्ने</li>
													<li class="date_v2">김**</li>
									...
									<a href="opinion_view.jsp">
										<dl class="online_list">
											<dt><span>सार्वजनिक </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">प्रेषित गर्ने</li>
													<li class="date_v2">김**</li>
									...
									<a href="opinion_view.jsp">
										<dl class="online_list">
											<dt><span>निजी </span>무주택세대주인 다문화가족에 대한 특별공급 관련 으로 문의드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">प्रेषित गर्ने</li>
													<li class="date_v2">김**</li>
									...
									<a href="opinion_view.jsp">
										<dl class="online_list">
											<dt><span>निजी </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">प्रेषित गर्ने</li>
													<li class="date_v2">김**</li>
