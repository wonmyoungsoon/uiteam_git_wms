					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">मोबालइबाट प्रमाणीकरण</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">मोबालइबाट प्रमाणीकरण</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">आई-पिन प्रमाणीकरण</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">आई-पिन प्रमाणीकरण</button>
										</div>
