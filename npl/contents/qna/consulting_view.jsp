					...
					<section>
						...
						<div class="online_write_wrap">
							...
							<div class="write_attentively">
								<section>
									<h2 class="blind">देहाएका कुराहरू सन्देश छोडेपछि पढ्नुहोस् ।</h2>
									<a href="#">
							...
							<section>
								...
								<div class="btn_type_v1">
									<button id="" name="" class="btn_round_brown" onclick="location.href='consulting_list.jsp'">सूचीकृत गर्नुहोस्</button>
								</div>
