...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/npl/style/css/reset.css">
		<link rel="stylesheet" href="/app/npl/style/css/layouts.css">
		<link rel="stylesheet" href="/app/npl/style/css/module.css">
		<link rel="stylesheet" href="/app/npl/style/css/main.css">
		<link rel="stylesheet" href="/app/npl//style/css/common.css">
		<link rel="stylesheet" href="/app/npl/style/css/intro.css">

		<script type="text/javascript" src="/app/npl/js/jquery.js"></script>
		<script type="text/javascript" src="/app/npl/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/npl/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/npl/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/npl/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/npl/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/npl/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/npl/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/npl/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 कोरियामा रहनसहन सहयोगी पुस्तिका</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/npl/contents/help/organization.jsp"><h3>मद्दत गरिएका संस्थाहरू</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/npl/contents/multicenter/near_list.jsp"><h3>बहुसांस्कृतिक परिवार सहायता केन्द्र</h3></a></li>
										<li><a href="/app/npl/contents/qna/callcenter.jsp"><h3>दनुरी कल सेन्टर</h3></a></li>
										<li><a href="/app/npl/contents/qna/consulting_list.jsp"><h3>अनलाइन परामर्श</h3></a></li>
										<li><a href="/app/npl/contents/opinion/opinion_list.jsp"><h3>वेबसाइट सुधारका लागि सुझाव</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">बारम्बार सोधिने प्रश्नहरू</h2>
								<ul>
								...
								<a href="/app/npl/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								<h2 class="h2_main_title">आपतकालीन सम्पर्कहरू</h2>
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>दनुरी कल सेन्टर<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>आगलागीबाट उद्दार, प्राथमिक उपचार, विपतबाट राहत, अस्पतालसम्बन्धी जानकारी<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>अपराध प्रतिवेदन<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
