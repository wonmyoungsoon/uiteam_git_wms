					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">ការបញ្ជាក់ភាពត្រឹមត្រូវតាមទូរស័ព្ទចល័ត</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">ការបញ្ជាក់ភាពត្រឹមត្រូវតាមទូរស័ព្ទចល័ត</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">ការបញ្ជាក់ភាពត្រឹមត្រូវ I-Pin</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">ការបញ្ជាក់ភាពត្រឹមត្រូវ I-Pin</button>
										</div>
