...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/khm/style/css/reset.css">
		<link rel="stylesheet" href="/app/khm/style/css/layouts.css">
		<link rel="stylesheet" href="/app/khm/style/css/module.css">
		<link rel="stylesheet" href="/app/khm/style/css/main.css">
		<link rel="stylesheet" href="/app/khm//style/css/common.css">
		<link rel="stylesheet" href="/app/khm/style/css/intro.css">

		<script type="text/javascript" src="/app/khm/js/jquery.js"></script>
		<script type="text/javascript" src="/app/khm/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/khm/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/khm/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/khm/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/khm/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/khm/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/khm/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/khm/contents/Life-inKorea/Life_inKorea.jsp"><h3>សៀវភៅណែនាំពីការរស់នៅក្នុងប្រទេសកូរ៉េ</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/khm/contents/help/organization.jsp"><h3>អង្គភាពដែលបានគាំទ្រ</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/khm/contents/multicenter/near_list.jsp"><h3>មជ្ឈមណ្ឌលទ្រទ្រង់គ្រួសារពហុវប្បធម៌</h3></a></li>
										<li><a href="/app/khm/contents/qna/callcenter.jsp"><h3>មជ្ឈមណ្ឌលទូរស័ព្ទដានូរី</h3></a></li>
										<li><a href="/app/khm/contents/qna/consulting_list.jsp"><h3>កន្លែងផ្ដល់យោបល់លើបណ្តាញ</h3></a></li>
										<li><a href="/app/khm/contents/opinion/opinion_list.jsp"><h3>ការផ្ដល់យោបល់កែលម្អគេហទំព័រ</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">សំណួរចោទសួរជាញឹកញាប់</h2>
								<ul>
								...
								<a href="/app/khm/contents/qna/faq.jsp" class="btn_more"><span class="blind">more</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								<h2 class="h2_main_title">លេខទំនាក់ទំនងគ្រាមានអាសន្ន</h2>
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>មជ្ឈមណ្ឌលទូរស័ព្ទដានូរី<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>ការសង្រ្គោះអគ្គីភ័យ ការសង្គ្រោះបឋម ជំនួយសង្គ្រោះពីគ្រោះមហន្ដរាយ ព័ត៌មានអំពីមន្ទីរពេទ្យ<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>ការរាយការណ៍អំពីឧក្រិដ្ឋកម្ម<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
