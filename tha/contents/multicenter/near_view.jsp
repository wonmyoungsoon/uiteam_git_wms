		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">ศูนย์ช่วยเหลือครอบครัวหลากหลายวัฒนธรรม</a>
						...
						<div class="tab_wrap">
							<section>
								...
								<ul class="tab_support_v1">
									<li><a href="near_list.jsp" class="on">ศูนย์ช่วยเหลือที่อยู่บริเวณใกล้เคียง<span>(1)</span></a></li>
									<li><a href="zone_list.jsp">ศูนย์ระดับภูมิภาค</a></li>
								</ul>
							</section>
						</div>
						<!-- //지원센터 바로가기 -->

						<!-- ศูนย์ช่วยเหลือที่อยู่บริเวณใกล้เคียง 상세 안내 -->
						<div class="online_write_wrap">
							<section>
								<h2 class="blind">ศูนย์ช่วยเหลือที่อยู่บริเวณใกล้เคียง 상세 안내</h2>
								...
								<section>
									...
									<div class="map_api">
										<img src="/app/tha/img/sub/common/@map.gif" alt="지도 정보">
									</div>
								</section>
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p>ศูนย์ช่วยเหลือครอบครัวหลากหลายวัฒนธรรมเป็นหน่วยงานที่ช่วยเหลือครอบครัวหลากหลายวัฒนธรรมให้สามารถใช้ชีวิตอยู่ในประเทศเกาหลีได้อย่างมั่นคง โดยศูนย์ช่วยเหลือทั้งหมด 217 แห่งทั่วประเทศจะให้บริการต่างๆ เช่น สอนภาษาเกาหลี ให้คำปรึกษาและการอบรมแก่ครอบครัว และโปรแกรมทางวัฒนธรรมต่างๆ เป็นต้น</p>
							</div>
