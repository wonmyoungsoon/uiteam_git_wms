		...
		<div id="wrap">
			...
			<div id="container" class="sub_container">
				...
				<header class="sub_header">
					...
					<h1 class="h1_support">
						<a href="#" class="btn_support">การตั้งค่า</a>
					</h1>
				</header>
				<!-- //online_header -->
						...
						<section>
							...
							<div class="setup_wrap">
								<div class="setup_list">
									ข้อมูลเกี่ยวกับเวอร์ชั่น <span class="setup_version">2.01(2)</span>
								</div>
								<div class="setup_list">
									ตกลงยอมรับข้อความเตือน
									<a href="#" class="btn_notice">
										<span class="btn_notice_move"></span>
									</a>
								</div>
								<div class="setup_list">
									<a href="#">ประเมินผลแอพ (เรทติ้ง) </a>
								</div>
								<div class="setup_list">
									<a href="http://www.liveinkorea.kr">เวบพอร์ทัลดานูรีสำหรับครอบครัวหลากหลายวัฒนธรรม</a>
								</div>
							</div>
						</section>
						<!-- //환경설정 상세 -->
