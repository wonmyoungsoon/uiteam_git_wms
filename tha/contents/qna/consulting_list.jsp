			...
			<div id="container" class="sub_container">
								...
								<div class="online_list_box">
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[ส่วนตัว] </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">ผู้เขียน</li>
									...
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[สาธารณะ] </span>무주택세대주인 다문화가족에 대한 특별공급 관련 으로 문의드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">ผู้เขียน</li>
													<li class="date_v2">김**</li>
									...
									<a href="consulting_view.jsp">
										<dl class="online_list">
											<dt><span>[สาธารณะ] </span>다누리 포털 관련 질문드립니다.</dt>
											<dd>
												<ul class="date_wrap_v2">
													<li class="date_tit color_black">ผู้เขียน</li>
													<li class="date_v2">김**</li>
						...
						<section>
							<div class="online_write_wrap">
								<div class="btn_type_v2">
									...
									<button id="" name="" class="btn_round_brown" onclick="location.href='consulting_write.jsp'" >สอบถาม</button>
								</div>
							</div>
						</section>
						<!-- //버튼 -->
				...
				<div class="help_wrap">
					<section>
						...
						<div class="help">
							<div class="help_text">
								<p><span class="text_bold">การให้บริการที่ปรึกษาแบบตัวต่อตัวจะให้บริการโดย "ดานูรีคอลเซ็นเตอร์"</span><br><br>
									ภาษาที่ให้บริการ :  13 ภาษา (ภาษาเกาหลี เวียดนาม จีน อังกฤษ ตากาล็อก(ฟิลิปปินส์) มองโกล รัสเซีย ไท, เขมร (กัมพูชา) ญี่ปุ่น อุสเบกิสถาน ลาว และเนปาล)<br><br>
									เวลาบริการ :  ตลอด 24 ชั่วโมง 365 วัน คุยแบบ 3 คน<br><br>
									หมายเลขโทรศัพท์  : 1577-1366
								</p>
							</div>
