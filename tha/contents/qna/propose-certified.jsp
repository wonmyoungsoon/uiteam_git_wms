					...
					<section>
						...
						<section>
							...
							<div class="online_auth">
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">การยืนยันตัวตนผ่านทางโทรศัพท์มือถือ</h3>
										<div class="img_phon"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">การยืนยันตัวตนผ่านทางโทรศัพท์มือถือ</button>
										</div>
								...
								<div class="auth_list">
									<section>
										<h3 class="blind">การยืนยันตัวตนด้วย I-Pin</h3>
										<div class="img_ipin"></div>
										<div class="btn_type_v4">
											<button id="" name="" class="btn_round_pink_v3" onclick="">การยืนยันตัวตนด้วย I-Pin</button>
										</div>
