...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="/app/tha/style/css/reset.css">
		<link rel="stylesheet" href="/app/tha/style/css/layouts.css">
		<link rel="stylesheet" href="/app/tha/style/css/module.css">
		<link rel="stylesheet" href="/app/tha/style/css/main.css">
		<link rel="stylesheet" href="/app/tha//style/css/common.css">
		<link rel="stylesheet" href="/app/tha/style/css/intro.css">

		<script type="text/javascript" src="/app/tha/js/jquery.js"></script>
		<script type="text/javascript" src="/app/tha/js/jquery.mobile-1.4.5.min.js"></script>
		<script type="text/javascript" src="/app/tha/js/blurPopup.js"></script>
		<script type="text/javascript" src="/app/tha/js/jquery.easing.js"></script>
		<script type="text/javascript" src="/app/tha/js/kor_xml_contents.js"></script>
		<script type="text/javascript" src="/app/tha/js/iscroll.js"></script>
		<script type="text/javascript" src="/app/tha/js/jquery.bxslider.js"></script>
		<script type="text/javascript" src="/app/tha/js/ui_common.js"></script>
				...
				<section>
					...
					<div class="main_content">
								...
								<div class="life_service_wrap_en">
									<section>
										...
										<ul class="life_service_v1_en">
											<li><a href="/app/tha/contents/Life-inKorea/Life_inKorea.jsp"><h3>2016 หนังสือคู่มือการดำรงชีวิตในประเทศเกาหลี</h3></a></li>
											<li><a href="#"><h3>결혼이민예정자를 위한 필수정보</h3></a></li>
											<li><a href="/app/tha/contents/help/organization.jsp"><h3>หน่วยงานที่ได้รับความช่วยเหลือ</h3></a></li>
										</ul>
									</section>
								</div>
							</div>
							...
							<div class="service_right_en">
								<section>
									...
									<ul class="main_service_wrap_v1_en">
										<li><a href="/app/tha/contents/multicenter/near_list.jsp"><h3>ศูนย์ช่วยเหลือครอบครัวหลากหลายวัฒนธรรม</h3></a></li>
										<li><a href="/app/tha/contents/qna/callcenter.jsp"><h3>ศูนย์บริการข้อมูลข่าวสารทางโทรศัพท์ดานูรี</h3></a></li>
										<li><a href="/app/tha/contents/qna/consulting_list.jsp"><h3>การให้คำปรึกษาทางออนไลน์</h3></a></li>
										<li><a href="/app/tha/contents/opinion/opinion_list.jsp"><h3>ข้อเสนอแนะการปรับปรุงเว็บไซต์</h3></a></li>
									</ul>
								</section>
							</div>
							<!-- //content_right -->
						...
						<div class="notice_wrap_en">
							<section>
								<h2 class="h2_main_title">คำถามที่พบบ่อย</h2>
								<ul>
								...
								<a href="/app/tha/contents/qna/faq.jsp" class="btn_more"><span class="blind">더보기</span></a>
							</section>
						</div>
						<!-- //notice_wrap -->
						...
						<div class="emergency_call_wrap_en">
							<section>
								<h2 class="h2_main_title">หมายเลขโทรศัพท์ฉุกเฉิน</h2>
								<ul class="emergency_call_en">
									<li><a href="#"><h3>다문화가족종합정보전화센터<br>ศูนย์บริการข้อมูลข่าวสารทางโทรศัพท์ดานูรี<span class="emergency_call_num">1577-1366</span></h3></a></li>
									<li><a href="#"><h3>ข้อมูลเกี่ยวกับการช่วยเหลือฉุกเฉินเมื่อเกิดไฟไหม้ การปฐมพยาบาลเบื้องต้น การบรรเทาสาธารณภัย และโรงพยาบาล<span class="emergency_call_num">119</span></h3></a></li>
									<li><a href="#"><h3>การแจ้งเหตุอาชญากรรม<span class="emergency_call_num">112</span></h3></a></li>
								</ul>
							</section>
						</div>
						<!-- //emergency_call_wrap -->
